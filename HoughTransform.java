...
public class HoughTransform {
    ...
    public static void main(String[] args) throws IOException {
        ArrayData inputData = getArrayDataFromImage("teste5.jpg");
        int minContrast = (10 >= 4) ? 64 : 0;
        ArrayData outputData = houghTransform(inputData, Integer.parseInt("255"), Integer.parseInt("255"), minContrast);
        writeOutputImage("resultadocaralho.jpg", outputData);
        return;
    }
}